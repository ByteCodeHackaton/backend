...
- [ ] [metod get  /employee/delete](Метод удаления сотрудника)
...
- [ ] [metod get  /passenger/delete](Метод удаления пассажира)
...
- [ ] [metod get  /order/delete](Метод удаления заявки на обслуживание пассажиров)
